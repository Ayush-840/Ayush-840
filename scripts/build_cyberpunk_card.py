    ...
    for y in range(grid_size):
        for x in range(grid_size):
            if mask_np[y, x] > 100 and final_pixels[y, x] > 128:
                ...
                # Cyberpunk Cyan/Purple dot-matrix accent coloring
...
def build_cyberpunk_banner():
  ...
  <defs>
    ...
    <!-- Glassmorphism Cyberpunk Border Gradient -->
    ...
    <pattern id="crtScanlines" width="880" height="4" patternUnits="userSpaceOnUse">
      <line x1="0" y1="0" x2="880" y2="0" stroke="#000000" stroke-opacity="0.22" stroke-width="1.2" />
    </pattern>
  ...
  <style>
    ...
    @keyframes glowBreathe {{
      0%, 100% {{ stroke-opacity: 0.7; filter: drop-shadow(0 0 5px rgba(6, 182, 212, 0.4)); }}
      50% {{ stroke-opacity: 1; filter: drop-shadow(0 0 12px rgba(168, 85, 247, 0.7)); }}
    }}
    .glowing-frame {{
      animation: glowBreathe 3.5s ease-in-out infinite;
    }}

    /* Continuous Seamless Photo <-> Code Logo Crossfade Transition */
    ...
    .portrait-layer {{
      animation: photoTransition 6s ease-in-out infinite;
      transform-origin: 116px 160px;
    }}
    .logo-layer {{
      animation: logoTransition 6s ease-in-out infinite;
      transform-origin: 116px 160px;
    }}
  ...
  <!-- Main Cyberpunk Terminal Container -->
  <rect width="880" height="440" rx="14" fill="url(#bgGrad)" stroke="url(#borderGrad)" stroke-width="1.5" />

  <!-- CRT Scanlines Overlay -->
  <rect width="880" height="440" rx="14" fill="url(#crtScanlines)" pointer-events="none" />
  ...
  <!-- LEFT: Dynamic Transition Frame (Dot-Matrix Portrait <-> Cyberpunk AI Logo) -->
  <g transform="translate(0, 0)">
    <!-- Outer Glassmorphic Frame with Breathing Glow -->
    <rect x="32" y="60" width="168" height="212" rx="10" fill="#161B22" fill-opacity="0.8" stroke="url(#borderGrad)" stroke-width="1.5" class="glowing-frame" />
    <rect x="40" y="68" width="152" height="196" rx="6" fill="#0A0E17" stroke="#30363D" stroke-width="1" />

    <!-- LAYER 1: Dithered Dot-Matrix Portrait -->
    <g class="portrait-layer">
{pixel_rects_svg}
    </g>

    <!-- LAYER 2: Stylized Cyberpunk AI / Code Logo -->
    <g class="logo-layer">
      <!-- Cyberpunk Hexagon & Code Icon -->
      <polygon points="116,92 156,115 156,162 116,185 76,162 76,115" fill="none" stroke="#06B6D4" stroke-width="2" filter="url(#neonGlow)" />
      <polygon points="116,100 148,118 148,158 116,176 84,158 84,118" fill="none" stroke="#A855F7" stroke-width="1.2" />
      
      <!-- Code Brackets & AI Core -->
      <path d="M 98 132 L 88 142 L 98 152" fill="none" stroke="#06B6D4" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M 134 132 L 144 142 L 134 152" fill="none" stroke="#06B6D4" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
  ...
  <!-- RIGHT: Terminal Content Header & SYSTEM.INFO HUD Panel -->
  <g transform="translate(222, 58)">
    
    <!-- Main Cyberpunk Heading -->
    ...
    <rect x="0" y="92" width="624" height="268" rx="10" fill="#161B22" fill-opacity="0.65" stroke="#30363D" stroke-width="1" />
    ...
    <g transform="translate(16, 138)" class="ui-text">
      ...
      <g transform="translate(0, 52)">
        ...
        <text x="90" y="12" fill="#8B949E" font-size="11.5">:</text>
        <text x="104" y="12" fill="#E6EDF3" font-size="12">Pune, Maharashtra, India 🇮🇳</text>
      </g>
  ...
  <!-- Outer Cyberpunk Corner Accents -->
  <path d="M 14 0 L 0 14" stroke="#06B6D4" stroke-width="2" />
  <path d="M 866 440 L 880 426" stroke="#A855F7" stroke-width="2" />
</svg>
'''
