...
def build_cyberpunk_banner():
  ...
  <style>
    ...
    /* Photo to Code Logo Crossfade Transition */
  ...
  <!-- LEFT: Dynamic Transition Frame (Dot-Matrix Portrait to Cyberpunk AI Logo) -->
...
{pixel_rects_svg}
    ...
    <g class="logo-layer">
      <!-- Cyberpunk Hexagon and Code Icon -->
